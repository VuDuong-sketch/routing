...
class DVrouter(Router):
    ...
    def handle_remove_link(self, port):
        ...
        if port not in self.ninks:
            return

        endpoint, _ = self.ninks[port]
